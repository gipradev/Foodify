...
public class SubmenuSheetFragment extends BottomSheetDialogFragment implements View.OnClickListener {
  private static final String TAG = "SubmenuSheetFragment";
  ...
  public SubmenuSheetFragment(Context applicationContext, String product_id, Snackbar snackbar) {
  ...
  public void onClick(View v) {
    ...
    switch (v.getId()) {
      ...
      case R.id.close:
        ...
        SubmenuSheetFragment.this.dismiss();
//        getActivity().finish();

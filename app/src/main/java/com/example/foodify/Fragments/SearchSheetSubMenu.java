...
public class SearchSheetSubMenu extends BottomSheetDialogFragment {
    private static final String TAG = "CategorySheetSubMenu";
    private final String productId;
    private final String chair_id;

    private final SearchActivity activity;
    private final SearchActivity.RecyclerSearchItems.MyViewHolder myHolder;
    ...
    public SearchSheetSubMenu(Context context, JSONObject jsonObject, String chairID, String product_id,
                              SearchActivity.RecyclerSearchItems.MyViewHolder holder, View parent_view, SearchActivity searchActivity) {
...
//                itemId.setText(object.getString("product_name"));
        ...
        closeButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                SearchSheetSubMenu.this.dismiss();
            }
        });
        ...
        addToCart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
              //  ToCart(userID,chairID,productId,subId,"1",1,myHolder);
            }
        });
    ...
    private void ToCart(final String userID, final String chairID, final String productId, final String subId, final String action,
                        final int productCount, final SearchActivity.RecyclerSearchItems.MyViewHolder myHolder) {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if(jsonObject.getString("status").equals("1")){
                        ...
                        SearchActivity.changeCartView(myHolder,activity, "1");
                        SearchSheetSubMenu.this.dismiss();

                        new SearchActivity().showSnackBar(getActivity(),userID, chairID, getActivity().getSupportFragmentManager());

                        //new HomePage().showSnackBar(getApplicationContext(), userID,chairID,getSupportFragmentManager());
                    }
                    else {

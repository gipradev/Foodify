...
public class RecyclerTodaySpecial extends RecyclerView.Adapter<RecyclerTodaySpecial.MyViewHolder> {
    private static final String TAG = "RecyclerTodaySpecial";
    ...
    public RecyclerTodaySpecial(Context applicationContext, JSONArray jsonArray, LinearLayout cartView,
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(context).inflate(R.layout.today_recycler_item,null);
...
//                        ToCartDialogue cartDialogue = new ToCartDialogue(HomePage.this,"asds");
//                        cartDialogue.show();

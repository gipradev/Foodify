...
public class RecyclerSearchItems extends RecyclerView.Adapter<RecyclerSearchItems.MyViewHolder> {
    private static final String TAG = "RecyclerSearchItems";
    ...
    private String product_id, sub_id;
    private String cartStatus = "0";
    ...
    public RecyclerSearchItems(Context applicationContext, JSONArray jsonArray, ProductsAdapterListener listener,
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder holder, final int position) {
        ...
        try {
            ...
            Log.e(TAG, holder.count.getText().toString() + "before Cart");
            ...
            // here get cart status and item count to display ,
    ...
    private void setProductItem(JSONObject object, MyViewHolder holder) {
        try {

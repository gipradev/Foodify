...
public class SearchSubMenuChange extends BottomSheetDialogFragment implements View.OnClickListener {
    ...
    private TextView itemCart;
    private Button addButton;
    private Button removeButton;
    private LinearLayout plusMinus;

    public SearchSubMenuChange(Context applicationContext, String product_id, Snackbar snackbar, int index,
                               RecyclerSearchItems recyclerSearchItems) {
    ...
    private void defineViews(View view) {
        ...
        plusMinus =(LinearLayout) view.findViewById(R.id.changeLayout);
...
//            case R.id.close:
//
//                SearchSubMenuChange.this.dismiss();
//                //  recycler.updateItem(position);
////        getActivity().finish();
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (jsonObject.getString("status").equals("1")) {
                        ...
                        recycler.updateItem(itemPosition);
...
//            Toast.makeText(context, "No data", Toast.LENGTH_SHORT).show();
                  //      snackBar.dismiss();
                        SearchSubMenuChange.this.dismiss();
                        Log.e(TAG, itemPosition + "         at botto");
                        recycler.updateItem(itemPosition);
        ...
        private void setCartValues(JSONObject object, MyViewHolder holder) {
            try {
                ...
                if (!object.getString("size").equals("0")) {
                    Log.e(TAG, "SIZE   : " + object.getString("size"));

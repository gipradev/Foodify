...
public class CategorySubMenuChange extends BottomSheetDialogFragment implements View.OnClickListener {
    ...
    public CategorySubMenuChange(Context applicationContext, String product_id, Snackbar snackbar, int index,
                                 RecyclerCategoryItems categoryItems) {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (jsonObject.getString("status").equals("1")) {
                        ...
                        CategorySubMenuChange.this.dismiss();
